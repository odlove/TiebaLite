...
class SubPostsRepositoryImplTest {
    ...
    @Test
    fun `pbFloor should return success flow when API call succeeds`() = runTest {
    ...
    @Test
    fun `pbFloor should propagate error when API call fails`() = runTest {
    ...
    @Test
    fun `pbFloor should handle default parameters correctly`() = runTest {
    ...
    @Test
    fun `pbFloor should handle page pagination correctly`() = runTest {
    ...
    @Test
    fun `pbFloor should handle subPostId parameter correctly`() = runTest {
    ...
    @Test
    fun `pbFloor should handle different threadId values`() = runTest {
