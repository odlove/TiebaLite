        ...
        if (themeUiDelegate.currentState.isTranslucent) {
            ...
            ImmersionBar.with(this).apply {
                if (customStatusColor != -1) {
                    ...
                    statusBarColorInt(
                        calcStatusBarColorInt(
                            themeUiDelegate.themeColor(this@BaseActivity, ThemeR.attr.colorToolbar)
                        )
                    )
                ...
                fitsSystemWindowsInt(
                    true,
                    themeUiDelegate.themeColor(this@BaseActivity, ThemeR.attr.colorBackground)
                )
                navigationBarColorInt(
                    themeUiDelegate.themeColor(this@BaseActivity, ThemeR.attr.colorNavBar)
                )
