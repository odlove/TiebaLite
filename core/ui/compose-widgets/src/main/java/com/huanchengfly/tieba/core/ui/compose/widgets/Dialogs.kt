...
import com.huanchengfly.tieba.core.ui.compose.widgets.dialogs.AnyPopDialog
import com.huanchengfly.tieba.core.ui.compose.widgets.dialogs.AnyPopDialogProperties
import com.huanchengfly.tieba.core.ui.compose.widgets.dialogs.DirectionState
import com.huanchengfly.tieba.core.ui.compose.widgets.TextButton
import com.huanchengfly.tieba.core.ui.compose.widgets.picker.TimePicker
...
fun TimePickerDialog(
    ...
    confirmText: String = stringResource(id = CoreUiR.string.button_sure_default),
    cancelText: String = stringResource(id = CoreUiR.string.button_cancel),
...
fun AlertDialog(
    ...
    modifier: Modifier = Modifier,
    onDismiss: (() -> Unit)? = null,
    confirmText: String = stringResource(id = CoreUiR.string.button_ok),
    title: @Composable (DialogScope.() -> Unit) = {},
    content: @Composable (DialogScope.() -> Unit) = {},
) {
    Dialog(
