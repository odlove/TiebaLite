package com.huanchengfly.tieba.core.ui.media.video
...
import com.huanchengfly.tieba.core.ui.media.video.util.getDurationString
...
fun VideoPlayer(
    ...
    DisposableEffect(videoPlayerController) {
        Log.d("VideoPlayer", "DisposableEffect start controller=${videoPlayerController.hashCode()}")
        videoPlayerController.initialize()
        onDispose {
            Log.d("VideoPlayer", "DisposableEffect dispose controller=${videoPlayerController.hashCode()}")
