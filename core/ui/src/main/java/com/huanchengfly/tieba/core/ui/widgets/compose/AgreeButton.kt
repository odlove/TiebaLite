    ...
    ActionBtn(
        icon = {
            Icon(
                ...
                contentDescription = stringResource(id = CoreUiR.string.desc_like),
            )
        },
        text = {
            Text(
                text = if (displayText.isEmpty())
                    stringResource(id = CoreUiR.string.title_agree)
                else displayText
            )
        },
        modifier = modifier,
...
private fun AgreeButtonPostDetail(
    ...
    Button(
        ...
        Row(
            ...
            Icon(
                imageVector = if (hasAgreed) Icons.Rounded.Favorite else Icons.Rounded.FavoriteBorder,
                contentDescription = stringResource(id = CoreUiR.string.title_agree),
                tint = animatedColor,
