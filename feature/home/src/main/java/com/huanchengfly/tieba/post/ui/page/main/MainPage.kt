    ...
    val navigationItems by remember {
        derivedStateOf {
            listOfNotNull(
                NavigationItem(
                    id = "home",
                    icon = { AnimatedImageVector.animatedVectorResource(id = HomeR.drawable.ic_animated_rounded_inventory_2) },
                ...
                if (hideExplore) null
                    ...
                    id = "explore",
                    icon = {
                        AnimatedImageVector.animatedVectorResource(id = HomeR.drawable.ic_animated_toy_fans)
                    },
                ...
                NavigationItem(
                    id = "notification",
                    icon = {
                        AnimatedImageVector.animatedVectorResource(id = HomeR.drawable.ic_animated_rounded_notifications)
                    },
                ...
                NavigationItem(
                    id = "user",
                    icon = {
                        AnimatedImageVector.animatedVectorResource(id = HomeR.drawable.ic_animated_rounded_person)
                    },
