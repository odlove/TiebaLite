...
import com.huanchengfly.tieba.post.ui.page.settings.destinations.AccountManagePageDestination
import com.huanchengfly.tieba.post.ui.page.settings.destinations.BlockSettingsPageDestination
import com.huanchengfly.tieba.post.ui.page.settings.destinations.CustomSettingsPageDestination
    ...
    if (account != null) {
        SettingsItem(
            ...
            leadingContent = {
                LeadingIcon {
                    Avatar(
                        data = StringFormatUtils.getAvatarUrl(account.portrait),
                        size = Sizes.Small,
